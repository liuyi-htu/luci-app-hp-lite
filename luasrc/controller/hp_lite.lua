...
function index()
    ...
    entry({"admin", "services", "hp-lite", "client"}, cbi("hp_lite/client"), title_client_config, 1).leaf = true
    entry({"admin", "services", "hp-lite", "client_log"}, view("hp_lite/client_log"), title_client_log, 2).leaf = true
    entry({"admin", "services", "hp-lite", "server"}, cbi("hp_lite/server"), title_server_config, 3).leaf = true
    entry({"admin", "services", "hp-lite", "server_log"}, view("hp_lite/server_log"), title_server_log, 4).leaf = true
