...
'}\n'
        ...
        var logEndpoint = '/cgi-bin/luci/admin/services/hp-lite/get_server_log';
        ...
        dom.content(log_box, makePre(hpTranslate('loading_server_log', 'Loading server log...')));
            ...
            fetch(logEndpoint)
                ...
                .then(res => {
                    var text = res.readable === false
                        ? hpTranslate('cannot_read_server_log_file', 'Cannot read server log file.')
                        : (res.log || hpTranslate('server_log_empty', 'Server log is empty.'));
                ...
                .catch(() => {
                    dom.content(log_box, makePre(hpTranslate('cannot_read_server_log_file', 'Cannot read server log file.')));
                });
        }
        ...
        }, hpTranslate('server_credit_text', 'This server was made by zhangyahao from HTU.'));
